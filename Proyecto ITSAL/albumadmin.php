...
if($_GET) {
//  BORRADO DE IMAGENES y FILAS en ALBUM
    //"DELETE FROM `alumnos` WHERE `alumnos`.`id` = ''";
    $id = $_GET['borrar'];
    $objConexion = new conexion();
    $imagen = $objConexion->consultarPruebaConexion("SELECT imagen FROM `alumnos` WHERE id=".$id);
    ...
    <div class="row">
        <div class="col-md-3">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="albumadmin.php" method="post" enctype="multipart/form-data">
            ...
            <table class="table">
                ...
                <?php foreach($alumnos as $alumno) { ?>
                    <tr>
                        ...
                        <td><a class="btn btn-danger" href="?borrar=<?php echo $alumno['id']; ?>">Eliminar</a></td>
                    </tr>
                <?php } ?>
                </tbody>
            </table>
